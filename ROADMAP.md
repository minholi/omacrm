...
| P4 | Campaign advanced: unsubscribe links, bounce classification, revenue tracking, double opt-in (next) | Marketing completeness | pending |
...
uv run python src/omacrm/manage.py test      # must be green (221 tests)

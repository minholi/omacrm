    ...
    EntityDef(
        ...
        fields={
            ...
            **ADDRESS_FIELDS,
            ...
            "opt_in_confirmed": FieldDef("opt_in_confirmed", "bool", _("Opt-In Confirmed"), read_only=True, model_field="opt_in_confirmed"),
            "opt_in_confirmed_at": FieldDef("opt_in_confirmed_at", "datetime", _("Opt-In Confirmed At"), read_only=True, model_field="opt_in_confirmed_at"),
        ...
        detail_layout=[
            ...
            {"title": _("Address"), "fields": ["address_street", "address_city", "address_state", "address_country", "address_postal_code"]},
            {"title": _("Conversion"), "fields": ["opt_in_confirmed", "opt_in_confirmed_at", "converted_at", "created_account", "created_contact", "created_opportunity"]},
            {"title": _("Assignment"), "fields": ["assigned_user", "teams", "created_at", "modified_at"]},
        ],
        stream=True,
        duplicate_check_fields=["name", "email_address"],
...
registry.register(
    EntityDef(
        ...
        detail_layout=[
            {"title": _("Overview"), "fields": ["name", "account", "contact", "stage", "amount", "amount_converted", "amount_weighted", "probability", "last_stage", "lead_source", "campaign", "close_date", "description"]},
            {"title": _("Assignment"), "fields": ["assigned_user", "teams", "created_at", "modified_at"]},
        ],
        stream=True,
...
registry.register(
    EntityDef(
        ...
        fields={
            ...
            "revenue": FieldDef("revenue", "currency", _("Revenue"), read_only=True, model_field="revenue"),
            **AUDIT_FIELDS,
        },
        ordering=["-created_at"],
        search_fields=["name", "description"],
        ...
        detail_layout=[
            ...
            {"title": _("Metrics"), "fields": ["sent_count", "opened_count", "clicked_count", "opted_out_count", "bounced_count", "revenue"]},
            {"title": _("Assignment"), "fields": ["assigned_user", "teams", "created_at", "modified_at"]},
        ],
        stream=True,
        duplicate_check_fields=["name"],

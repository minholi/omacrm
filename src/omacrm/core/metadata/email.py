...
registry.register(
    EntityDef(
        ...
        fields={
            ...
            "folder": FieldDef("folder", "varchar", _("Folder"), read_only=True, model_field="folder"),
            "thread_id": FieldDef("thread_id", "varchar", _("Thread"), read_only=True, model_field="thread_id"),
            "parent_email": FieldDef("parent_email", "link", _("In Reply To"), read_only=True, model_field="parent_email"),
        ...
        detail_layout=[
            {"title": _("Message"), "fields": ["subject", "from_address", "to_address", "cc_address", "date_sent", "is_read", "status", "assigned_user", "folder"]},
            {"title": _("Body"), "fields": ["body", "body_plain"]},
            {"title": _("System"), "fields": ["message_id", "thread_id", "parent_email", "created_at", "modified_at"]},
        ],
        stream=False,
        icon="mail",
    )
